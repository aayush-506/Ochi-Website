...
const Footer = () => {
    return (
        <div  className='h-full w-screen bg-white rounded-t-xl pt-[10vh] px-13'>

            <div className='w-full h-[80%] flex'>
                <div className='w-[50.7%] h-full '>
                    <h1 className='font-[Founders_Grotesk] uppercase leading-[0.75] text-[133px]'>eye-</h1>
                    <h1 className='font-[Founders_Grotesk] uppercase leading-[0.75] text-[133px]'>opening</h1>
                </div>


                <div className='w-[49.3%] h-full '>

                    <h1 className='font-[Founders_Grotesk] uppercase leading-[0.75] text-[133px]'>Presentations</h1>

                    <div className='container grid grid-cols-2 mt-14 font-[Neue_Montreal] text-[16px] '>
                        <div className='first h-[20vh] '>
                        ...
                        <div ></div>
                        <div className='third h-[20vh]  '>

                            <p className='mb-2'>L:</p>
                            <span className='block ' >202-1965 W 4th Ave</span>
                            <span className='block ' >Vancouver, Canada</span><br/>
                            <span className='block ' >30 Chukarina St</span>
                            <span className='block ' >Lviv, Ukraine</span>

                        </div>
                        <div className='fourth h-[20vh]  ml-[16vw]'>
                        ...
                        <div className='fourth h-[13.5vh] pt-6  '>
            ...
            <div className='flex w-full h-[100px] mt-8 '>
                ...
                <div className='w-[49.3%] flex font-[Neue_Montreal] text-[#B3B3B3]'>
                    <div className='w-1/2  flex'>
                        <p>© ochi design 2025.</p>
                        <a href="">Legal Terms</a>
                    </div>
                    <div className='w-1/2 pl-[16vw] whitespace-nowrap '>
